//Refactored this to NavigationMenu.tsx
...
//       off: "w-64"
//     },
//     inner: "h-full overflow-y-auto overflow-x-hidden bg-gradient-to-tr from-[#010102] to-[#1e293b] py-4 px-3 no-scrollbar"
//   },
//   collapse: {
...
// export function SidebarComponent({ isExpanded, onNewListingClick, onNewAgentClick }: SidebarProps) {
